        ...
        <section className="relative overflow-hidden bg-neutral-950 py-20 sm:py-24 lg:py-28">
            ...
            <div
                className="
                    pointer-events-none
                    absolute inset-0
                    bg-[radial-gradient(circle_at_50%_50%,color-mix(in_srgb,var(--primary)_10%,transparent)_0%,transparent_55%)]
                "
            />
            ...
            <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
                ...
                <motion.p
                    ...
                    "
                >
                    Join thousands of members who choose VitaForge to reshape their bodies and minds.
                </motion.p>
